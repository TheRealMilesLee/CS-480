...
class MoverState(ProblemState):
  ...
  def illegal(self):
    ...
    """
    if not isinstance(self.itemA, str) or not isinstance(self.itemB, str) or not isinstance(self.itemC, str) or not isinstance(self.mover, str) : return 1
    return 0
  ...
  def equals(self, state):
    ...
    state are equal.
    """
    return self.itemA==state.itemA and self.itemB==state.itemA and self.itemC==state.itemC and self.mover ==state.mover
...
Search(MoverState("Elephant", "Big Mouse", "Cheese","Mover"), MoverState("", "", "",""))
